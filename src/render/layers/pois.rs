...
static POI_ENTRIES: LazyLock<Vec<PoiEntry>> = LazyLock::new(|| {
    ...
    let entries = vec![
        ...
        (17, 18, N, N, Institution, "dentist", Extra::default()),
        (17, 18, N, N, Institution, "doctors", Extra::default()),
        (17, 18, N, N, Institution, "clinic", Extra { icon: Some("doctors"), ..Extra::default() }),
        ...
        (18, NN, N, N, Poi, "bench", Extra::default()),
        ...
        (19, NN, N, N, Poi, "bollard", Extra::default()),
        (19, NN, N, N, Poi, "block",  Extra { icon: Some("bollard"), ..Extra::default() }),
        (19, NN, N, N, Poi, "turnstile",  Extra { icon: Some("bollard"), ..Extra::default() }),
        (19, NN, N, N, Poi, "log",  Extra { icon: Some("bollard"), ..Extra::default() }),
